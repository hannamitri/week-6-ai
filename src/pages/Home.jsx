...
const Home = ({ setBase64Image }) => {
  const [isDropAreaVisible, setDropAreaVisible] = useState(true);
  ...
  const handleDragEnter = () => setDropAreaVisible(true);
  const handleDragLeave = () => setDropAreaVisible(false);
        ...
        <nav>
          <div class="row nav__row">
            <div class="nav__logo">
              <img
                class="nav__logo--img"
                src="./assets/logo.2c489fc453a1783cbadacf914efa3df6.svg"
                alt="logo"
              />
            ...
            <div class="nav__links">
              ...
              <a href="#" class="nav__link nav__link--primary">
                Sign Up
              </a>
            </div>
            ...
            <div class="row header__row">
              <div class="header__description">
                <h1>
                  ...
                  <span class="purple">in Seconds.</span>
                </h1>
                <p class="header__description--para">
                  Our AI powered tool automatically removes backgrounds from
                  your images with perfect precision. Fast, free, no sign-up
                  required.
                </p>
                ...
                <img
                  src="./assets/customers-logo-strip.680ac7c2e8ae28161d2c.png"
                  alt=""
      ...
      <main>
              ...
              <div class="features">
                <div class="feature">
                  <div class="feature__row">
                    <figure class="feature__img--wrapper">
                      <img
                        src="./assets/shield-icon.daefe14b320b14fbd9cbd18908ac93ec.svg"
                        alt=""
                        class="feature__img"
                      />
                    </figure>
                    <div class="feature__text">
                      ...
                      <p class="feature__para">
                        We strictly only deal with vendors that provide top
                        notch security.
                      </p>
                    </div>
                  </div>
                ...
                <div class="feature">
                  <div class="feature__row">
                    <figure class="feature__img--wrapper">
                      <img
                        src="./assets/support-icon.f9253ffa8cb6ffde5bbaa05eb5136375.svg"
                        alt=""
                        class="feature__img"
                      />
                    </figure>
                    <div class="feature__text">
                      ...
                      <p class="feature__para">
                        Lorem ipsum donor amet siti ceali ut enim ad minim
                        veniam, quis nostrud.
                      </p>
                    </div>
                  </div>
                ...
                <div class="feature">
                  <div class="feature__row">
                    <figure class="feature__img--wrapper">
                      <img
                        src="./assets/customize-icon.367468c90fd796009b97fbfba67b2c6a.svg"
                        alt=""
                        class="feature__img"
                      />
                    </figure>
                ...
                <div class="feature">
                  <div class="feature__row">
                    <figure class="feature__img--wrapper">
                      <img
                        src="./assets/fast-icon.dbb971a73d4805d2fc3bcdacdb55beba.svg"
                        alt=""
                        class="feature__img"
                      />
                    </figure>
                ...
                <div class="feature">
                  <div class="feature__row">
                    <figure class="feature__img--wrapper">
                      <img
                        src="./assets/simple-icon.673b7e1750b2a4ef32907fc164828d00.svg"
                        alt=""
                        class="feature__img"
                      />
                    </figure>
            ...
            <div class="row">
              <div class="quality__description">
                ...
                <h2 class="section__title">
                  ...
                  <span class="purple">Professionals.</span>
                </h2>
              ...
              <figure class="quality__img--wrapper">
                <img
                  src="./assets/hero-screenshot-1.40a097b525c2f8c9808e.png"
                  alt=""
                  class="quality__img"
                />
          ...
          <div class="container">
            <div class="row">
              <figure class="steps__img--wrapper">
                <img
                  src="./assets/hero-screenshot-2.241aac1fbc66db29d873.png"
                  alt=""
                  class="steps__img"
                />
                <svg
        ...
        <section id="values">
          <div class="container">
            <div class="row">
              ...
              <img
                class="values__img"
                src="./assets/prototype-illustration.21bc4b3f612a2f257c3d361067582485.svg"
                alt=""
              />
            </div>
          </div>
        ...
        <section id="testimonials">
          <div class="container">
            <div class="row">
              <img
                src="./assets/love-illustration.c759090fa833369ad6ffb6eb19cacb3e.svg"
                alt=""
        ...
        <div class="row footer__row">
          ...
          <div class="footer__bottom">
            <div class="footer__logo">
              <img
                src="./assets/logo-light.d9a5d1b5be5ea077b26864fdfc2e96a4.svg"
                alt=""
